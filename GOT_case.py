...
assertEquals(correct_title("sansa stark, lady of winterfell."), "Sansa Stark, Lady of Winterfell.")
assertEquals(correct_title("lord eddard stark, hand of the king."), "Lord Eddard Stark, Hand of the King.")
